...
class _ReportScreenState extends State<ReportScreen> {
  ...
  List<AddLeadModel> _getFilteredLeadsFor(
    ...
    // hasDateFilter is true whenever dates are actually set (including "Today")
    final hasDateFilter =
        filter.fromDate.isNotEmpty && filter.toDate.isNotEmpty;
  ...
  String _getDateTextFor(FilterResult? filter) {
    ...
    if (!hasDateFilter) return 'Filtered by Staff$staffText';
  ...
  Future<void> _handleFilterTapGeneric(
    ...
    if (result != null) {
      // hasDateFilter is true whenever dates are actually set (including "Today")
      final hasDateFilter =
          result.fromDate.isNotEmpty && result.toDate.isNotEmpty;

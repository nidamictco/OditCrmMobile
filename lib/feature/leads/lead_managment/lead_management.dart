...
// import 'package:odit_crm_mobile/feature/leads/lead%20managment/widgets/analytics_card.dart';
// import 'package:odit_crm_mobile/feature/leads/lead%20managment/widgets/lead_card.dart';
// import 'package:odit_crm_mobile/feature/leads/lead%20managment/add_lead.dart';
// import 'package:odit_crm_mobile/feature/leads/lead%20managment/filtering.dart';
...
//                           StatusCard(data: statusCards[index]),
//                     ),
//                     SizedBox(height: 2.h),

//                     // Section header — chart button highlighted when in report view
//                     SectionHeader(
//                       title: 'New Leads',
//                       subtitle: '40 Leads',
...
//                 },
//                 child: _isReportView
//                     ? _ReportSection(key: const ValueKey('report'))
//                     : _LeadListSection(
...
// // ─────────────────────────────────────────────
// // LEAD LIST SECTION  (extracted for AnimatedSwitcher key)
// // ─────────────────────────────────────────────
...
// // ─────────────────────────────────────────────
// // REPORT SECTION  (extracted for AnimatedSwitcher key)
// // ─────────────────────────────────────────────
...
// // ─────────────────────────────────────────────
// // SECTION HEADER  (one new param: isReportActive)
// // ─────────────────────────────────────────────

// // class SectionHeader extends StatelessWidget {
// //   final String title;
// //   final String subtitle;
// //   final bool isReportActive;        // ← NEW
...
// //     this.isReportActive = false,    // ← default false
// //     required this.onAdd,
...
// //               // ── Chart button: highlighted when report is active ──────────
// //               ActionButton(
...
//     this.areAllExpanded = false, // ← default false
//     required this.onAdd,
//     required this.onChart,
//     required this.onFilter,
//     required this.onSearch,
...
//               ),
//               SizedBox(width: 1.5.w),
//               // ── Menu button: icon reflects expansion state ───────────
//               ActionButton(
//                 icon: areAllExpanded
//                     ? Icons.table_rows
...
class LeadManagmentScreen extends StatefulWidget {
  const LeadManagmentScreen({super.key});

  @override
  State<LeadManagmentScreen> createState() => _LeadManagmentScreenState();
}

class _LeadManagmentScreenState extends State<LeadManagmentScreen> {
  int _selectedTab = 0;
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // ── Content Area ──────────────────────────────────────────────
          Expanded(
            child: LeadListScreen(selectedTab: _selectedTab),
          ),
        ],
      ),
    );

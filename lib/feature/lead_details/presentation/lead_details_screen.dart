...
import 'package:odit_crm_mobile/feature/lead_details/widgets/followup_form_card.dart';
import 'package:odit_crm_mobile/feature/lead_details/widgets/followup_history_card.dart';
import 'package:odit_crm_mobile/feature/lead_details/widgets/lead_tab_bar.dart';
import 'package:odit_crm_mobile/feature/lead_details/widgets/quick_action_button.dart';
import 'package:odit_crm_mobile/feature/lead_details/widgets/lead_details_tab.dart';
import 'package:odit_crm_mobile/feature/lead_details/widgets/lead_activities_tab.dart';
...
class _LeadDetailsScreenState extends State<LeadDetailsScreen> {
  ...
  void initState() {
    ...
    // FIX: Do NOT pre-set _selectedLeadStage / _selectedCategory here.
    // They will be set to the first valid item from the loaded stages/categories
    // list inside the BlocBuilder, once those lists are available.
    // This prevents the "value not found in items" Flutter assertion.
        ...
        child: Scaffold(
          ...
          body: BlocListener<AddLeadCubit, AddLeadState>(
            ...
            child: BlocBuilder<AddLeadCubit, AddLeadState>(
              // FIX: Only rebuild when stages/categories/submitting change —
              // avoids re-render from getLeadById status emissions.
                              ...
                              children: [
                                if (!_showFollowupForm) ...[
                                  ...
                                  if (stages.isNotEmpty &&
                                    ...
                                    // Show a loading indicator while stages/
                                    // categories are still being fetched.
                                    const Padding(
                                      padding: EdgeInsets.symmetric(
                                        vertical: 24,
                                      ),
